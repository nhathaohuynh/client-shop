...
import { Footer, Header, Sponsored } from "../components";
...
const Faq = () => {
  ...
  return (
    <div className={`${styles.section} my-8 mt-16`}>
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                brief explanation of why you are returning the item.
              </p>
            </div>
          )}
        </div>
          ...
          {activeTab === 5 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                you have ordered, you can return them for a refund within 30
                days of delivery.
              </p>
            </div>
          )}
